...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "sedra", cfg.RPCServer, "address of the sedrad node, default `localhost:221100`")
	...
	log.Printf("\tSedra:          %s", cfg.RPCServer)
	...
	if err := sedrastratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
